...
import {
  GitBranch, Search, Loader2, ArrowRight, FolderOpen,
...
export default function ContentGapToolPage() {
  ...
  const handleProjectSelect = (projectId: string) => {
    router.push(`/tool1/${projectId}/content-gap`);
  };
    ...
    <PageTransition className="min-h-screen">
      ...
      <div className="px-6 py-8 border-b border-[hsl(var(--glass-border-subtle))]">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">İçerik Boşluğu Analizi</h1>
            <p className="text-muted-foreground">
              Rakiplerinizin ele aldığı ama sizin ele almadığınız konuları keşfedin
            </p>
          </div>
        </div>
