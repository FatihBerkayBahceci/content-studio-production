...
import {
  Lightbulb, Search, Loader2, ArrowRight, FolderOpen,
...
export default function StrategyToolPage() {
  ...
  const handleProjectSelect = (projectId: string) => {
    router.push(`/tool1/${projectId}/strategy`);
  };
    ...
    <PageTransition className="min-h-screen">
      ...
      <div className="px-6 py-8 border-b border-[hsl(var(--glass-border-subtle))]">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">İçerik Stratejisi</h1>
            <p className="text-muted-foreground">
              AI destekli içerik stratejisi ve yayın planı oluşturun
            </p>
          </div>
        </div>
