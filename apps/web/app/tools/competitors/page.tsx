...
import {
  Globe, Search, Loader2, ArrowRight, FolderOpen,
...
export default function CompetitorsToolPage() {
  ...
  const handleProjectSelect = (projectId: string) => {
    router.push(`/tool1/${projectId}/competitors`);
  };
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Rakip sitelerinizi analiz edin ve içerik stratejilerini keşfedin
            </p>
          </div>
        </div>
